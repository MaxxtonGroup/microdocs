...
var index_1 = require("@maxxton/components/filters/index");
var sort_by_http_method_pipe_1 = require("../../pipes/sort-by-http-method.pipe");
var endpoint_panel_1 = require("../endpoint-panel/endpoint.panel");
var index_2 = require("@maxxton/components/components/index");
var router_1 = require("@angular/router");
var path_highlight_panel_1 = require("../path-highlight-panel/path-highlight.panel");
/**
 * @author Steven Hermans
 */
var EndpointGroupPanel = (function () {
    function EndpointGroupPanel() {
        this.hidden = true;
    }
    __decorate([
        core_1.Input(), 
