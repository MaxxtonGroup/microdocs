...
public class ProductService {
     ...
     */
    public Page<Customer> getProducts(Pageable pageable) {
     ...
     */
    public Customer getProduct(String email){
     ...
     */
    public Customer getProduct(Long customerId){
    ...
    public boolean removeCustomer(Long customerId) {
        Customer customer = getProduct(customerId);
        if(customer != null){
