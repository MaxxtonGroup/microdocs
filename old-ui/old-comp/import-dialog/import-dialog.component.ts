...
export class ImportDialogComponent {
  ...
  onProjectInserted( $event ) {
    ...
    if ( this.project.info ) {
      ...
      if ( this.project.info.tag ) {
        this.projectInfo.version = this.project.info.tag;
      }
    }
  }
  ...
  onSubmit() {
    ...
    this.projectService.importProject( this.project, this.projectInfo.title, this.projectInfo.group, this.projectInfo.version ).subscribe( ( project: Project ) => {
