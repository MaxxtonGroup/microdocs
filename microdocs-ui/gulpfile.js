...
gulp.task('compile-sass', [], function () {
  return gulp.src('src/assets/scss/**/*.scss')
      ...
      .pipe(gulp.dest(settings.distFolder + '/assets/css'));
});

gulp.task('compile-assets', [], function () {
  gulp.src('src/assets/fonts/**/**').pipe(gulp.dest(settings.distFolder + '/assets/fonts'));
  gulp.src('src/assets/i18n/**/**').pipe(gulp.dest(settings.distFolder + '/assets/i18n'));
  return gulp.src('src/assets/images/**/**').pipe(gulp.dest(settings.distFolder + '/assets/images'));
});
...
gulp.task('config', function () {
  return gulp.src('src/config/config-' + settings.env + '.ts')
      ...
      .pipe(gulp.dest(settings.distFolder + '/config'));
});
...
gulp.task('clean', [], function () {
  return gulp.src(settings.distFolder, {read: true}).pipe(clean());
});
...
gulp.task('package-distribution', [], function () {
  return gulp.src(['node_modules/**/*.d.ts', 'node_modules/**/*.js', 'node_modules/**/*.js.map', '!node_modules/**/node_modules', '!node_modules/**/node_modules/**']).pipe(gulp.dest(settings.distFolder));
});