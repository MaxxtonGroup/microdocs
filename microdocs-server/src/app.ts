    ...
    routes.forEach((route) => {
      route.methods().forEach((method) => {
        ...
        if (!router[requestMethod]) {
          throw new Error("unknown request method: " + requestMethod + " for path: " + path);
        }
