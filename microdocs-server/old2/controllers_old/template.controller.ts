...
export class TemplateController {
  ...
  public async editTemplate(@Body({required:true}) template:Template, @Param( "templateName" ) templateName: string, @QueryParam( "env", { required: false } ) envName?: string):Promise<Template>{
    let env = await this.getEnv(envName);
    ...
    // Create template
    return await this.templateService.editTemplate(env, template);
  }
